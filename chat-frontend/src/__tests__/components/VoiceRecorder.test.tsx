...
describe('VoiceRecorder Component', () => {
  ...
  it('stops recording and uploads when stop button is pressed', async () => {
    ...
    ;(mockAudioRecorder as any).uri = mockUri
    mockAudioRecorder.isRecording = true
  ...
  it('handles recording permission errors', async () => {
    mockAudioRecorder.prepareToRecordAsync.mockRejectedValue(new Error('Permission denied'))
  ...
  it('disables button when disabled prop is true', () => {
    const { getByText } = render(
      <VoiceRecorder onVoiceRecorded={mockOnVoiceRecorded} onError={mockOnError} disabled={true} />,
    )
