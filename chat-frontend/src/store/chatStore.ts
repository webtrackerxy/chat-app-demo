...
export const useChatStore = create<ChatState>((set, get) => {
  ...
  return {
        ...
        if (response.success) {
          ...
          set((state) => ({
            conversations: state.conversations.map((conv) =>
              conv.id === conversationId ? { ...conv, messages: deduplicatedMessages } : conv,
            ),
            currentConversation:
          ...
          set((state) => ({
            ...
            currentConversation:
              state.currentConversation?.id === conversationId
                ? {
                    ...state.currentConversation,
                    messages: state.currentConversation.messages.find(
    ...
    deleteConversation: async (conversationId: string) => {
      ...
      console.log(
        '🗑️ Storage API has deleteConversation method:',
        typeof storageApi.deleteConversation,
      )
    ...
    updateConversation: async (conversationId: string, title: string) => {
      ...
      console.log(
        '✏️ Storage API has updateConversation method:',
        typeof storageApi.updateConversation,
      )
